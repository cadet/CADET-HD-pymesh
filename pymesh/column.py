...
class Column:
    ...
    def __init__(self, container, packedBed, fragment=True, copy=False, periodicity:str='', endFaceSections=1, logger=Logger(level=1)):
        """
    ...
    def fragment(self, object, tool, copyObject=False, copyTool=False, removeObject=False, removeTool=False, cleanFragments=False, cleanAll=False):
        ...
        # List of entities generated by fragmenting the last input entity: container
